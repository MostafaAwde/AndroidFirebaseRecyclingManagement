...
public class DriverViewTasks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_view_tasks);

        tasksRef = FirebaseFirestore.getInstance().collection("tasks");
        back = findViewById(R.id.backToDriverHome);
        ...
        ls.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(getApplicationContext(), DriverUpdateTask.class);
